...
const SupportPage = ({ user, isRTL = true }) => {
  ...
  const quickActions = [
    { icon: '❓', text: 'كيف أربح نقاط؟', query: 'كيف يمكنني ربح النقاط من التطبيق؟' },
    { icon: '💰', text: 'كيف أسحب أرباحي؟', query: 'كيف يمكنني سحب أرباحي من التطبيق؟' },
    { icon: '📱', text: 'مشكلة تقنية', query: 'أواجه مشكلة تقنية في التطبيق' },
    { icon: '🎯', text: 'الإعلانات لا تظهر', query: 'الإعلانات لا تظهر لدي، ما الحل؟' },
    { icon: '👤', text: 'مشكلة في حسابي', query: 'أواجه مشكلة في حسابي' },
    { icon: '📊', text: 'كيف أصبح معلن؟', query: 'كيف يمكنني الإعلان في التطبيق؟' }
  ];
