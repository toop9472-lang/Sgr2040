...
- [x] **شريط تقدم مزدوج (برتقالي للإعلان + أزرق للنقطة) ✅ محدث**
...
- [x] **عداد مشاهدة قابل للسحب ✅ جديد**
- [x] **أزرار تنقل بأقواس ( ) ✅ جديد**
- [x] **نظام يمنع التنقل قبل إكمال 30 ثانية ✅ جديد**
- [x] **نقطة واحدة كل دقيقة مشاهدة ✅ جديد**
...
### 9. نظام النقاط ✅
- [x] **نقطة واحدة لكل دقيقة مشاهدة ✅ محدث**
- [x] 500 نقطة = 1 دولار
- [x] حد يومي: 50 إعلان
- [x] **يجب مشاهدة 30 ثانية على الأقل للتنقل ✅ جديد**
...
### v3.2.0 (فبراير 2025) - New
- إضافة خيار "تذكرني" في تسجيل الدخول
- عداد مشاهدة قابل للسحب في عارض الإعلانات
- أزرار تنقل بأقواس بيضاء ( )
- نظام يمنع التنقل قبل إكمال 30 ثانية من المشاهدة
- تحديث نظام النقاط: نقطة واحدة كل دقيقة مشاهدة
